...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        gridLayout_5->addWidget(typeLabel, 12, 0, 1, 1);
        ...
        gridLayout_5->addLayout(gridLayout_4, 11, 0, 1, 2);
        ...
        gridLayout_5->addWidget(typeComboBox, 13, 0, 1, 2);
        ...
        gridLayout_5->addWidget(gCostCellSpinBox, 9, 0, 1, 2);

        sizeLabel = new QLabel(tab_3);
        sizeLabel->setObjectName("sizeLabel");
        sizeLabel->setFont(font);

        gridLayout_5->addWidget(sizeLabel, 4, 0, 1, 1);
        ...
        gridLayout_5->addWidget(fCostLabel, 6, 0, 1, 1);

        sizeCellSpinBox = new QSpinBox(tab_3);
        sizeCellSpinBox->setObjectName("sizeCellSpinBox");
        sizeCellSpinBox->setFont(font);
        sizeCellSpinBox->setMinimum(10);
        sizeCellSpinBox->setMaximum(50);
        sizeCellSpinBox->setValue(20);

        gridLayout_5->addWidget(sizeCellSpinBox, 5, 0, 1, 2);
        ...
        gridLayout_5->addWidget(fCostCellSpinBox, 7, 0, 1, 2);
    ...
    void retranslateUi(QMainWindow *MainWindow)
    {
        ...
        label_4->setText(QCoreApplication::translate("MainWindow", "Columns x Rows", nullptr));
        label_6->setText(QCoreApplication::translate("MainWindow", "Wall thicnnes", nullptr));
        label_7->setText(QCoreApplication::translate("MainWindow", "Walls Color", nullptr));
